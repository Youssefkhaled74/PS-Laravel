  ...
  <div class="card">
    <div class="toolbar">
      <div class="title-wrap">
        <h2 class="h2">{{ __('admin.categories.create_title') }}</h2>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="form">
      ...
      <div class="form-group">
        ...
        <input type="text" name="name_en" class="input" value="{{ old('name_en') }}">
      </div>

      <div class="form-group">
        <label class="label">{{ __('admin.categories.name_ar') }}</label>
        <input type="text" name="name_ar" class="input" value="{{ old('name_ar') }}">
      </div>

      <div class="form-group">
        <label class="label">{{ __('admin.categories.status') }}</label>
        <select name="status" class="input">
          <option value="active">{{ __('admin.categories.active') }}</option>
          <option value="inactive">{{ __('admin.categories.inactive') }}</option>
        </select>
      </div>

      <div class="form-group">
        <label class="label">{{ __('admin.categories.sort_order') }}</label>
        <input type="number" name="sort_order" class="input" value="{{ old('sort_order', 0) }}">
      </div>
